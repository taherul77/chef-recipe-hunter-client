...
const About = () => {
  return (
    <div>
        ...
        <div className="container p-4 mx-auto space-y-16 sm:p-10">
          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex space-x-6">
              <img
                alt=""
                className="flex-1 flex-shrink-0 object-cover h-56 mb-4 bg-center rounded-sm "
            ...
            <div className="flex space-x-6">
              <img
                alt=""
                className="flex-1 flex-shrink-0 object-cover h-56 mb-4  rounded-sm "
      ...
      <section className="py-6 ">
        <div className="space-y-4">
          <h3 className="text-2xl text-center mb-8 font-bold leading-none sm:text-5xl">
			Contact us
          </h3>
        </div>
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          <div className="py-6 md:py-0 md:px-6">
            <h1 className="text-4xl font-bold">Perfect Food</h1>
